...
ggplot(combd, aes(y = mean, x = yr, col = subregion)) + # geom_point(size  = 0.5, position = pd3) + 
  geom_pointrange(aes(ymin = mean - sd, ymax = mean + sd), position = pd3, size  = 0.75) + theme_classic() + facet_grid(param ~ ., scales = "free_y") + ylab("") 
