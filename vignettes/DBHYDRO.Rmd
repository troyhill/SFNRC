...
Among the tools provided in the `SFNRC` R package is a simple, streamlined means of interacting with the DBHYDRO hydrology and water quality. This vignette demonstrates some of the DBHYDRO functionality.
...
The starting point for DBHYDRO hydrologic data is identifying the relevant DBKey. getDBkey displays the DBkeys associated with a structure. The input is not case sensitive, and partial searches will return broader results. The default behavior for `getDBkey()` is to return active DBkeys; those with new data added during the past 90 days. Setting the argument `activeOnly = FALSE` returns all DBkeys. 
