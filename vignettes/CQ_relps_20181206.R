...
wqlng <- melt(wq2, id.vars = c("stn", "date", "flow", "head_water", 
                               "tail_water", "stage", "year", "mo", "day", "seas", "waterYr"))
nrow(wqlng)
...
### "HARDNESS.AS.CACO3"  "MAGNESIUM" "SILICA" "SODIUM" "SP.CONDUCTIVITY..FIELD" "SULFATE" : geogenic solutes
### "PHOSPHATE..DISSOLVED.AS.P" "PHOSPHATE..TOTAL.AS.P"  "AMMONIA.N"  "CHLOROPHYLL.A"
