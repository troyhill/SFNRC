...
# usage examples: 
hyd.long  <- dfe.hydro(stns = stations)
hyd.wide <- dfe.hydro(stns = stations, data_shape = "wide")
hyd.vwide <- dfe.hydro(stns = stations, data_shape = "really_wide")
   
# simultaneously grab water quality data:
hydro.test4 <- dfe.hydro(stns = stations, data_shape = "wide", getWaterQuality = TRUE, parameter_list = c("flow", "head_water"), target_analytes = "PHOSPHATE, TOTAL AS P")
